        ...
        <div class="offset-md-3 col-md-6  " >
            ...
            <div class="panel panel-card margin-b-30">
                ...
                <div class="panel-body" style="padding-top:5px;">
                    ...
                    <form class="form-horizontal" action="../editmarker/{{$editpins->id}} " method="post">
                     ...
                     <fieldset>
                        ...
                        <div class="form-group">
                           ...
                           <div class="col-md-12">
                              ...
                              <div class="input-group">
                                 ...
                                 <option value="{{$editpins->status}}">{{$editpins->status}}</option>
                        ...
                        <div class="form-group">
                           ...
                           <div class="col-md-12">
                              ...
                              <button type="submit" class="btn btn-warning pull-right">Edit Marker <span class="glyphicon glyphicon-send"></span></button>
