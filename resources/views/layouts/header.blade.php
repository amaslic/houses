...
<html lang="en">
    ...
    <head>
        ...
        <link href="{{ asset('plugins/simple-line-icons-master/css/simple-line-icons.css')}}" rel="stylesheet" type="text/css" />
    ...
    <script type="text/javascript" src="https://cdn.rawgit.com/prashantchaudhary/ddslick/master/jquery.ddslick.min.js" ></script>
        ...
        <link href="{{ asset('css/dajanstyle.css')}}" rel="stylesheet" type="text/css" />
